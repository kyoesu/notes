...
![pic]()Выбор метода «Логистическая регрессия»
...
![pic]()Вызов окна настройки нормализации
...
![pic]()Окно настройки нормализации данных
...
![pic]()Пример настройки обучающей выборки
...
![pic]()Настройка параметров остановки обучения
